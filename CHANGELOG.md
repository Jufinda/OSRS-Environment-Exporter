...
### Updated to work with Rev. 237 06/05/2026

- Updated to work with Rev.237, Jagex no longer encrypts cache archives, Thanks to DennisDev over at OSRS.World for the help.

## 2.6.0

### Updated to work 16/04/2026

- Used Google Gemini to bring everything up to date, now works with Revision 236 (2026-03-18) does not work with Revision 237 (2026-03-25) It will load a 237 Revision but cannot locate Terrain files.
